...
createVecchiaModel<-function(datafilename,path_files,id_file,id_sim,id_mask,kVecchia,tau2obs,subsamp,
  ...
  ## Load data 
  fn_sim=paste0(path_files,datafilename,".h5")
  dat_sim=h5dump(fn_sim)
  z_sim=dat_sim$data_norm[,,id_sim]
  mask=dat_sim$mask_sub[,,id_mask]
